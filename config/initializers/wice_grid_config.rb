if defined?(Wice::Defaults)
  ...
  #
     ...
     range_two:  ['ViewColumnRangeTwo', 'ConditionsGeneratorColumnRangeTwo'],
     range_1:  ['ViewColumnRangeR1', 'ConditionsGeneratorColumnR1'],
     range_2:  ['ViewColumnRangeR2', 'ConditionsGeneratorColumnR2'],
     range_3:  ['ViewColumnRangeR3', 'ConditionsGeneratorColumnR3'],
     date_custom:  ['ViewColumnDateCustom', 'ConditionsGeneratorColumnDateCustom']
     }
  #
...
module Wice
  module Controller
    undef_method :export_grid_if_requested
    def export_grid_if_requested(opts = {})
      ...
      if grid
        ...
        send_file_rails2 temp_filename, filename: filename, type: 'application/vnd.ms-excel; charset=utf-8'
